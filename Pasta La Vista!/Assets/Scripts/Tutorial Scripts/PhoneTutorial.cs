...
public class PhoneTutorial : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (fPController.phonePressed && tutorial.phaseThree)
        {
            phone.SetActive(true);
            audioSource.PlayOneShot(equipPhone);

            tutorial.phone.SetActive(false);
            tutorial.firstOrderTutorial = true;
            ...
            if (tutorial.firstPhonePickup)
            {
                tutorial.firstOrderTutorial = true;
                tutorial.phone.SetActive(false);
                tutorial.rivalReviews.SetActive(true);
            }
        }
            else
        {
    ...
    public void ResumeGame()
    {
        ...
        tutorial.rivalReviews.SetActive(false);
        tutorial.playerReviews.SetActive(true);
    }
